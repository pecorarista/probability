...
\newlist{equivconditions}{enumerate}{1}
\setlist[equivconditions]{label=(\alph*)}
...
\newcommand\Family[1]{{\langle {#1}_\lambda \rangle}_{\lambda \in \Lambda}}
...
\newcommand\eventuallyin[2]{#1 \mathrel{\text{eventually in}} #2}
\newcommand\frequentlyin[2]{#1 \mathrel{\text{frequently in}} #2}
