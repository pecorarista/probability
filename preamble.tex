...
\newfontfamily\phoneticfont{Times LT Std Phonetic}
...
\newfontfamily\cjkfontsf{Hiragino Kaku Gothic ProN}
\newfontfamily\cjkfonttt{Hiragino Maru Gothic ProN}

\usepackage{covington}
\setglossoptions{%
    fsii=\normalfont\upshape\phoneticfont,
