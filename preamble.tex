...
\newcommand\Sequence[1]{{\langle #1_n \rangle}_{n \in \PositiveInteger}}
\newcommand\Sequencen[1]{{\langle #1_n \rangle}_{n \in \PositiveInteger}}
\newcommand\SimpleSequencen[1]{{\langle #1_n \rangle}_{n}}
\newcommand\Family[1]{{\langle #1_\lambda \rangle}_{\lambda \in \Lambda}}
\newcommand\SimpleFamily[1]{{\langle #1_\lambda \rangle}_{\lambda}}
