...
また乗法\(\otimes\)を\(\symbb{R}\)における通常の加法に，無限大に関する規則（\definitionref{extended-real}）を加えたものとする．このとき\(\langle \symbb{R} \cup \{\infty\}, \mathord{\otimes}, 0 \rangle\)はモノイドである．
