...
\pronunciation{Колмогоров}{ru}{kəlmɐˈɡorəf}{コルモゴロフ．現代の一般的なラテン文字転写ではKolmogorovと綴られるが，出版物の著者名としてはKolmogoroffが使われている}}によるもので，その本質は確率がみたしてほしい性質を列挙したものである．
...
詳しくは\secref{kolmogorov}の\citetitle{kolmogorov}の引用およびその解説を参照せよ．}．
...
\pronunciation{Laplace}{fr}{laplas}{ラプラス}
}によると，
結果全体を同じくらい起こりやすい場合に分けて，着目する事象に当てはまる場合の数をすべての場合の数で割ったものをその事象の確率とする\footnote{%
\secref{laplace}の\citetitle{laplace}の引用およびその解説も参照せよ．}．
