...
2つの分割\(\Delta = \tuple{x_0, \ldots, x_n}\)と\(\Delta' = \tuple{x_0', \ldots, x_m'}\)が与えられたとき，任意の\(i \in \{0, \ldots, n\}\)について\(x_i = x_j'\)となるような\(j\)が存在するとき，\(\Delta'\)は\(\Delta\)の\keyword{細分}(refinement)\index{さいぶん@細分 refinement}であるという．
