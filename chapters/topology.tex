...
\begin{exa} \(S^1\)を単位円周とする．図形\(T = S^1 \times S^1\)をトーラスという．
\(f \colon T \to T, \tuple{\theta_1, \theta_2} \mapsto \tuple{\theta_1 + \alpha, \theta_2 + \beta}\)は連続写像である．
\end{exa}
...
\begin{figure}
    ...
    beginfig(1);
        ...
        path circum, curvefront, curveback;
        ...
        path shadowback, shadowfront;
        shadowback = buildcycle(point 1 of curveback {direction 1 of curveback} .. point 1/16 of curveback, curveback, reverse curveback);
        ...
        A = image(
            ...
            label.lft("$\scriptstyle \theta_1$", point 0 of loop) withcolor 2/3 red;
            draw subpath (3.6, 4.3) of ring withpen pencircle scaled 4 withcolor white;
            drawarrow subpath (-2, 6) of ring withcolor 2/3 blue;
            label.bot("$\scriptstyle \theta_2$", point 6 of ring) withcolor 2/3 blue;
            draw torus;
        );
        draw A;
