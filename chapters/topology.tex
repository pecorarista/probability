...
それは次のようにして確認できる．任意の\(\tuple{\lambda_1, U_1}, \tuple{\lambda_2, U_2} \in \symcal{D}\)をとる．
\exampleref{neighborhood-directed-set}で見たように，
\(U_3 := U_1 \cap U_2\)とするとこれは\(U_3 \in \Neighborhood{x}\), \(U_1 \preceq U_3\), \(U_2 \preceq U_3\)をみたす．
