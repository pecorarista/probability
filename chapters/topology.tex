...
\corollarylabel{topology-continuity-neighborhood}
\end{corollary}
\end{thmbox}

\begin{proof}
\refimpliesref{\definitionref{topology-continuity-at-x}}{\corollaryref{topology-continuity-neighborhood}}：\(f(x)\)の任意の近傍\(V\)について，\propositionref{f-set}の\ref{f-f-inv-a}より\(f(f^{-1}(V)) \subseteq V\)あ
\end{proof}
